...
import { SiReact, SiNextdotjs, SiTypescript, SiNodedotjs, SiTailwindcss, SiFramer, SiMongodb } from 'react-icons/si';
import { experiences, Experience } from '@/data/experience';
import { projects, Project } from '@/data/projects';
import Link from 'next/link';
import Image from 'next/image';

// Map tech strings to icons
export const getTechIcon = (tech: string) => {
  const t = tech.toLowerCase();
  if (t.includes('react')) return <SiReact className="text-[#61DAFB]" />;
  if (t.includes('next.js')) return <SiNextdotjs className="text-black dark:text-white" />;
  ...
  return (
    ...
    >
      <div className="flex items-center gap-5">
        <div className="w-12 h-12 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center text-xl font-bold text-gray-500 shadow-sm">
      ...
      */}
      ...
      >
        <div className="flex items-start justify-between p-6 sm:p-8 border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-[#111] z-10 sticky top-0">
          <div className="flex items-center gap-5">
            <div className="w-16 h-16 rounded-2xl bg-white dark:bg-[#161616] border border-gray-200 dark:border-gray-700 flex items-center justify-center text-2xl font-bold text-gray-400 shadow-sm flex-shrink-0">
              {experience.company.charAt(0)}
            </div>
            <div>
